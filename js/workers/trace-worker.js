self.onmessage = function (ev) {
  try {
    ...
    self.postMessage({ ok:true, geometry:{ width_mm: width*mmPerPixel, height_mm:height*mmPerPixel, hadUnits:false, subpaths:subpaths, trace:{widthPx:width,heightPx:height,threshold:threshold,worker:true,nodesBefore:nodesBefore,nodesAfter:nodesAfter} } });
